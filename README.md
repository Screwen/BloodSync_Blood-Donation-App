...
* **Android:** [📥 Download BloodLine_v1.0.0_arm64.apk](https://github.com/Screwen/Blood-Donation-App/releases/download/v1.0.0/app-release.apk) 📱
...
│   ├── components/            # UI Units (Buttons, Inputs, Cards)
